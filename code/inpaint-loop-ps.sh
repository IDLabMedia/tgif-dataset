...
echo "Start script"
inpainting_model_name="ps" # For Photoshop / Firefly, this script is only to calculate NIMA/GIQA/ITM scores. NOT to generate inpainted images.
...
python3 inpaint-loop.py \
    ...
    --use_ps_mask_for_splicing --ps_mask_dir "$PS_MASK_DIR" \
    --verbose "$VERBOSE" \
