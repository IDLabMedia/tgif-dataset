...
MIN_RANDOM_MASK_SIZE=64
MAX_RANDOM_MASK_SIZE=64

SAVE_DIR=output_random_${inpainting_model_name}
mkdir -p $SAVE_DIR

SAVE_ORIG_DIR=output_random_${inpainting_model_name}_orig
...
skip_cmd=
#SKIP_DIR=output_random_${inpainting_model_name}
